...
type IconName =
  ...
  | 'bolt' | 'star' | 'check' | 'share' | 'sound' | 'flag' | 'info' | 'deck';
...
export function Icon({ name, size = 22, color = 'currentColor', stroke = 2 }: Props) {
  ...
  const paths: Record<IconName, React.ReactNode> = {
    ...
    gear:    <g {...p}><circle cx="12" cy="12" r="3.2"/><path d="M12 3v2.4M12 18.6V21M5 5l1.7 1.7M17.3 17.3L19 19M3 12h2.4M18.6 12H21M5 19l1.7-1.7M17.3 6.7L19 5"/></g>,
